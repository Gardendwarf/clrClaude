 ...
 **УВАГА**: Додає ВСІ зміни до індексу, створює коміт та відправляє на віддалений сервер. Використовуйте лише коли впевнені, що всі зміни належать разом.
...
- Загалом: +AAA вставок, -BBB видалень
 ...
 Безпека: Без секретів | Без великих файлів | [попередження]
...
** Памʼятайте**: Завжди переглядайте зміни перед push. Якщо сумніваєтесь, використовуйте окремі git-команди для більшого контролю.
